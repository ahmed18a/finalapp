...
public class notifications extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        uid=user.getUid();
        myRef= database.getReference("notifications"+uid);
    ...
    protected void createEditTextView(@NonNull View view) {
        ...
        if (hint>=2) {
            temp = view.findViewById(hint-1);
            myRef.push().setValue(temp.getText().toString());
        }
        temp=view.findViewById(hint);
